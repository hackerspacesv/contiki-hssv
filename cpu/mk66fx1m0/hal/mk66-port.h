//+------------------------------------------------------------------------------------------------+
//| PORT peripheral registers for Kinetis MK66 MCU.                                                |
//|                                                                                                |
...
//Digital filter clock register bitfields
#define PORT_DFCR_CS_Bus_Clock  (0 << 0)  //Select clock source
#define PORT_DFCR_CS_Lpo_Clock  (1 << 0)

//Digital filter width register bitfields
#define PORT_DFWR_FILT_Msk  0x0000001F
#define PORT_DFWR_FILT_Pos  0
