...
//----------------------
#ifdef TEENSY_36_CONF_STDOUT_UART_ENABLED
#define STDOUT_UART_ENABLED TEENSY_36_CONF_STDOUT_UART_ENABLED
#else
#define STDOUT_UART_ENABLED 0
#endif //TEENSY_36_CONF_STDOUT_UART_ENABLED

#ifdef TEENSY_36_CONF_STDOUT_UART_INSTANCE
#define STDOUT_UART_INSTANCE CC_CONCAT_EXT_2(UART, TEENSY_36_CONF_STDOUT_UART_INSTANCE)
#define STDOUT_UART_RX_ALT   CC_CONCAT_EXT_3(UART, TEENSY_36_CONF_STDOUT_UART_INSTANCE, _RX)
#define STDOUT_UART_TX_ALT   CC_CONCAT_EXT_3(UART, TEENSY_36_CONF_STDOUT_UART_INSTANCE, _TX)
#else
...
#ifdef TEENSY_36_CONF_STDOUT_UART_RX_PIN
#define STDOUT_UART_RX_PIN TEENSY_36_CONF_STDOUT_UART_RX_PIN
#else
#define STDOUT_UART_RX_PIN BOARD_PIN_0
#endif //TEENSY_36_CONF_STDOUT_UART_RX_PIN

#ifdef TEENSY_36_CONF_STDOUT_UART_TX_PIN
#define STDOUT_UART_TX_PIN TEENSY_36_CONF_STDOUT_UART_TX_PIN
#else
